...
export default {
  ...
  actions: 'Actions',
  setGroup: 'Set group',
  setPanorama: 'Set as panorama',
  cancelPanorama: 'Cancel panorama',
  littlePlanet: 'Little planet',
  normalPanorama: 'Normal',
  ...
  clear: 'clear',
  clearAll: 'Clear all',
  mediaToBeUploaded: 'Images/videos to be uploaded',
  located: 'Located',
  linked: 'Linked',
  linkTrack: 'Link track',
  settingSuccess: 'Setting saved!',
  ...
  GVector: 'G Vector',
  GVector3D: 'G 3D',
  showOverlay: 'Show roads',
  tileOverlays: 'Overlays',
  addOverlay: 'Add overlay',
  overlayName: 'Name',
  overlayUrl: 'Url',
  noOverlay: 'No overlays',
  notSet: 'Not set',
  edit: 'Edit',
  exitEdit: 'Exit edit',
  address: 'Url',
  ...
  description: {
    ensureToDissolveGroup: 'Are you sure you want to disband the group? This group will be disbanded, and the images/videos within the group will still be retained!',
    ensureToDeleteGroup: 'Are you sure you want to delete the group? This group will be deleted, the images within the group will not be retained, and the videos within the group will only be unlinked!',
    ...
    confirmDeleteUser: 'Are you sure you want to delete the user? All the images and videos of this user will also be deleted and cannot be restored!',
    ...
    noMediaCanUpload: 'No image/video can be uploaded. Please improve the location information or upload a new file!',
    mediaUploadedSuccess: 'Upload successful!',
    someMediaUploadedSuccess: 'Partially uploaded!',
    needVideoGPSInfo: 'The video has no location info. Please locate it manually or link it to a track before importing!',
    selectVideoFailed: 'Failed to select video!',
    videoImportFailed: 'Failed to import video!',
    videoImportSuccess: 'Video imported successfully!',
    videoImportFailedNamed: 'Failed to import video "{name}"',
    videoNoLocation: 'This video has no location info',
    videoLinkedTrackNoLocation: 'This video is linked to a track and has no standalone coordinates',
    videoNeedGpsOrLocate: 'A video needs embedded GPS or manual location before importing',
    videoLoadFailed: 'Failed to load video',
    trackNotExist: 'Track does not exist',
    videoLinkedAndUploaded: 'Video linked to track and uploaded',
    alignSaved: 'Alignment saved',
    nodeExist: 'Node already exists! Please edit the existing node',
    noMarkerInstance: 'No marker instance provided',
    noImageId: 'No image id provided'
  },
  placeholder: {
